...
import { CoronaComponent } from 'app/entities/corona/corona.component';
import { CoronaService } from 'app/entities/corona/corona.service';
import { Corona } from 'app/shared/model/corona.model';

describe('Component Tests', () => {
  describe('Corona Management Component', () => {
    let comp: CoronaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CoronaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.coronas && comp.coronas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
